...
<header style="background-color: #333; color: #fff; padding: 15px 0; text-align: center;">
    <nav>
        <ul style="list-style: none; padding: 0; margin: 0; display: flex; justify-content: center; gap: 100px;">
            ...
            <li><a href="veilletechno.php" style="color: #fff; text-decoration: none;">Veille Technologique</a></li>
